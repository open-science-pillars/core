...
Per SPECIFICATION.md v0.5.1 §6 (fixtures policy): synthetic
...
- era5like_t2m.nc: ERA5-like monthly 2 m temperature, 5 degree global grid,
  ...
  A bad-data variant adds unmasked sentinels and impossible
...
# Bad-data variant (for the QC behavior tests). Defect
